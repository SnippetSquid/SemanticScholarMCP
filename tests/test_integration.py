...
class TestIntegration:
    ...
    def check_api_key(self):
        ...
        if not os.getenv("SEMANTIC_SCHOLAR_API_KEY"):
            pytest.skip("Integration tests require SEMANTIC_SCHOLAR_API_KEY environment variable")
    ...
    async def test_get_paper_real_api(self):
        ...
        result = await get_paper("10.1038/nature14539", fields="title,authors,year,abstract")
